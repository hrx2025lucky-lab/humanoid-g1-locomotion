...
UNITREE_MODEL_DIR = "source/unitree_rl_lab/unitree_rl_lab/assets/robots/unitree_model"  # Replace with the actual path to your unitree_model directory
UNITREE_ROS_DIR = "source/unitree_rl_lab/unitree_rl_lab/assets/robots/unitree_ros"  # Replace with the actual path to your unitree_ros package

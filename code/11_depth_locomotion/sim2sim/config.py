...
# LOGS_DIR = "path/to/instinctlab/logs/instinct_rl/g1_parkour/20260729_115301"
# PARKOUR_POLICY_FILE = os.path.join(LOGS_DIR, "exported", "actor.onnx")
# PARKOUR_DEPTH_ENCODER_FILE = os.path.join(LOGS_DIR, "exported", "0-depth_encoder.onnx")
...
# Initial MuJoCo free-camera view. Rendering cameras such as
# viewer_follow_camera and depth_camera remain selectable in the viewer.
VIEWER_LOOKAT = (15.0, 0.0, 0.5)
VIEWER_DISTANCE = 32.0
VIEWER_AZIMUTH = 0.0
VIEWER_ELEVATION = -50.0

# Keyboard velocity command increments and limits.
...
RESIZED_DEPTH_IMAGE_SHAPE = (36, 64)  # (height, width)

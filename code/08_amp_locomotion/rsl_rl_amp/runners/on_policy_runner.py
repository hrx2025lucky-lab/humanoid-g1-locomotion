...
from rsl_rl_amp.utils import check_nan, normalize_runner_config, resolve_callable
from rsl_rl_amp.utils.logger import Logger
...
class OnPolicyRunner:
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device: str = "cpu") -> None:
        ...
        self.env = env
        self.cfg = normalize_runner_config(train_cfg)
        self.device = device
        ...
        for it in range(start_it, total_it):
            ...
            with torch.inference_mode():
                for _ in range(self.cfg["num_steps_per_env"]):
                    ...
                    # Book keeping
                    reward_components = getattr(self.alg, "last_reward_components", None)
                    logging_rewards = (
                        reward_components["mixed"] if reward_components is not None else rewards
                    )
